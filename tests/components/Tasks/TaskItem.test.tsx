...
import { renderTaskItemWithProviders } from "../../testUtils/renderUtils";
...
describe("<TaskItem />", () => {
  it("Should show correct task text and checkbox", async () => {
    ...
    const taskItem = screen.getAllByRole("button", { name: /todo task item/i }); //TaskItem turns to button role via react-beautiful-dnd
  ...
  it("Should show close(*) icon button when user hovers,", async () => {
    ...
    const taskItem = screen.getByRole("button", { name: /todo task item/i }); //TaskItem turns to button role via react-beautiful-dnd
